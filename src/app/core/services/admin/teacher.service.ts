...
// import { TeacherRequest } from '../models/teacher-request.model'; // Import the TeacherRequest for adding/updating
...
//     return this.http.post<TeacherResponse>(this.apiUrl, teacher, { headers });
//   }
